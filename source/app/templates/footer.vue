<template lang="pug">
footer.footer.footer-center.bg-base-200.text-base-content.p-4
  ...
  .grid-flow-col.gap-4
    a
      i.fa-lg.fab.fa-twitter
    a
      i.fa-lg.fab.fa-youtube
    a
...
<script setup>
//footer.footer.p-10.bg-neutral.text-neutral-content
...
const webDesc = site.value.description

//.site-footer
//  | MIT Licensed |
//  | Copyright © 2021-2022
//  a.vitepress(:href="website") {{ webTitle }}
//  br
//  | Powered by
//  a.vitepress(target="_blank"
//    href="//vitepress.vuejs.org/") VitePress
